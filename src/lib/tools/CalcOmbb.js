...
function CalcOmbb(convexHull)
{
  ...
  let UpdateOmbb = function(leftStart, leftDir, rightStart, rightDir, topStart, topDir, bottomStart, bottomDir)
  {
  ...
  var maxPt = new Vector(-1 * Number.MAX_VALUE, -1 * Number.MAX_VALUE);
